import { LanguageMetaData, type Module, inject } from 'langium';
...
export function createHelloWorldServices(context: DefaultSharedModuleContext): {
    ...
    const JsonLanguageMetaData = {
        languageId: 'test-json',
        fileExtensions: ['.test.json'],
    ...
    shared.ServiceRegistry.register(Json);
